...
const Zenith = () =>{
	return(
		<div className="zenith2  ">
		   <p className="What-is-Zenith  b--white ma4">
		      What is Zenith?
		   </p>
		   <div className="div1   b--white">
                <svg className="svg1    b--white" xmlns="http://www.w3.org/2000/svg" width="221" height="56" viewBox="0 0 221 56">
				    <text fill="#F5A623" fill-rule="evenodd" font-family="Overpass-Bold, Overpass" font-size="76" font-weight="bold" transform="translate(-181 -515)">
				        <tspan x="178.468" y="570">Zenith</tspan>
				    </text>
				</svg>


				<svg className="svg2   pa0  b--white" xmlns="http://www.w3.org/2000/svg" width="283" height="289" viewBox="0 0 283 289">
		   ...
		   <div className=" div2  b--white w-50-ns w-100">
		     <p className="para1 white">
               Zenith, a carnival of technofanatics, is a catalogue of events hosted by Manan, the technical coding society of JC Bose University, YMCA, Faridad. It is a blend of programming and gaming events which intend to ignite a spark in the minds of students with which they can explore their creative, technical and innovative potential to the maximum extent possible.
		     </p>
		     <p className="para2 white">
		       The purpose of the event is to inculcate the spirit of coding and develop a healthy competitive environment among the participants.
		     </p>
		   </div>
